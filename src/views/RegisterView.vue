...
export default{
    ...
    methods:{
        ...
        registerUser(){
            ...
            if(this.username.length < 3 || this.username.length > 10 || this.correo.match(pastronEmail) == null || this.correo.includes('.') == false || this.password.match(mayusculas) == null || this.password.match(minusculas) == null || this.password.match(numeros) == null){
                Swal.fire({
                    position: "center",
                    icon: "error",
